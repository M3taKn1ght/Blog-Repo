...
const char* PubTopicTempOne = "sensors/out/ESP32-Living/TempOne";        //Topic first temp
const char* PubTopicPresOne = "sensors/out/ESP32-Living/PressOne";       //Topic first pressure
const char* PubTopicHumOne =  "sensors/out/ESP32-Living/HumOne";         //Topic first humidity
String clientID = "ESP-DevKit_Livingroom";  //Clientname for MQTT-Broker
